    ...
    ?>
        ...
        <div class="row">
          ...
          <div class="right" style="background-color:#1A1717;">
              <?php
                $sql = "SELECT COUNT(categorie) FROM produse WHERE categorie=4";
              ...
              $sql = "SELECT id_prod, denumire, descriere, imagine, pret, imagine, stoc, discount FROM produse where categorie=4";
            $result = $conn->query($sql);
