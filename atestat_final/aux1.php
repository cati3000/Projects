    ...
    ?>
        ...
        <div class="row">
          ...
          <div class="right" style="background-color:#1A1717;">
              <?php
                $sql = "SELECT COUNT(categorie) FROM produse WHERE categorie=1";
              ...
              $sql = "SELECT id_prod, denumire, descriere, imagine, pret, imagine, stoc, discount FROM produse where categorie=1";
            $result = $conn->query($sql);
                        ...
                        <center><table style="border:2px solid black;" >
                          <tr>
                              ...
                              <td id="formatare_col_doi"> 
                                  ...
                                  <h3 style="padding-left:20px; color:white"><?php echo $array['denumire']?>
                                  <?php
