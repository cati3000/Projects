...
<!--          <div class="left" style="background-color:#4CAF50;">-->
            ...
            <img id="da" src="turbina2.jpg">
          </div>

          <div class="right" style="background-color:#1A1717;">
              <table id="ped" border="1px" bordercolor="white">
                  <tr>
                      <td id="formatare_col_doi"><h2 style="color:white; padding-left:20px;">Turbina ProTuning P1 65mm Carcasa Magneziu</h2></td>
                  </tr>
                  <tr>
                      <td id="formatare_col_doi"><p style="color: white;">Detalii: <br> - Dimensiuni(L x l x H mm): 380 x 330 x 320 <br> - Diametru Admisie: 65mm <br> - Diametru Evacuare: 57mm<br> - Tip rulmenti: alama <br>- Presiune maxima(de la 3500 rpm): 1,8 bar/ 26,1 psi <br>- Material Admisie: Magneziu<br>- Material Evacuare: Fonta <br> - Distanta prinderi flansa evacuare: 105mm </p></td>
                  </tr>
              </table>
          </div>
            <div class="mostright" style="background-color:black;">
                <h1 style="color:white;">1749.99 RON</h1>
                <form>
