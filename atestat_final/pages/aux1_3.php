...
<!--          <div class="left" style="background-color:#4CAF50;">-->
            ...
            <img id="da" src="turbina3.jpg">
          </div>

          <div class="right" style="background-color:#1A1717;">
              <table id="ped" border="1px" bordercolor="white">
                  <tr>
                      <td id="formatare_col_doi"><h2 style="color:white; padding-left:20px;">Turbina ProTuning P2 72mm Cu Rulmenti Ceramici</h2></td>
                  </tr>
                  <tr>
                      <td id="formatare_col_doi"><p style="color: white;">Detalii: <br> - Dimensiuni(L x l x H mm): 390 x 340 x 340 <br> - Diametru Admisie: 72mm <br> - Diametru Evacuare: 65mm<br> - Tip rulmenti: Ceramici <br>- Presiune maxima(de la 3500 rpm): 2,0 bar/ 28.9 psi <br>- Material Admisie: Duraluminiu<br>- Material Evacuare: Fonta <br> - Distanta prinderi flansa evacuare: 110mm</p></td>
                  </tr>
              </table>
          </div>
            <div class="mostright" style="background-color:black;">
                <h1 style="color:white;">1999.99 RON</h1>
                <form>
