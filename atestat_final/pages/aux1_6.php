...
<!--          <div class="left" style="background-color:#4CAF50;">-->
            ...
            <img id="da" src="intercular3.jpg">
          </div>

          <div class="right" style="background-color:#1A1717;">
              <table id="ped" border="1px" bordercolor="white">
                  <tr>
                      <td id="formatare_col_doi"><h2 style="color:white; padding-left:20px;">Intercooler ProTuning IN/OUT 45mm</h2></td>
                  </tr>
                  <tr>
                      <td id="formatare_col_doi"><p style="color: white;">Detalii: <br> - Dimensiuni(L x l x H mm): 500 x 93 x 220 <br> - Diametru Intrare/ Iesire: 45mm <br>- Material: Aluminiu <br> - Distanta prinderi(diagonala): 523mm </p></td>
                  </tr>
              </table>
          </div>
            <div class="mostright" style="background-color:black;">
                <h1 style="color:white;">399.99 RON</h1>
                <form>
