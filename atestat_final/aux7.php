    ...
    ?>
        ...
        <div class="row">
          ...
          <div class="right" style="background-color:#1A1717;">
              <?php
                $sql = "SELECT COUNT(categorie) FROM produse WHERE categorie=7";
              ...
              $sql = "SELECT id_prod, denumire, descriere, imagine, pret, imagine, stoc, discount FROM produse where categorie=7";
            $result = $conn->query($sql);
             foreach ($result as $index => $array)   
             {
                 ...
                 ?>
                          ...
                          <tr>
                                <td id="formatare_col_unu"><img style="width:300px; height:200px" src="<?php echo $id?>"></td>
